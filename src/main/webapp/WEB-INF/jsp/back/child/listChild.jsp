...
<head>
    ...
    <script>
        function del(id) {
            if (confirm('您确定删除吗？')) {
                window.location.href = "child/del?id=" + id;
            }
        }

        function toEdit(id) {
            window.location.href = "child/toEdit?id=" + id;
        }

        function toAdd() {
            window.location.href = "child/toAdd";
        }
    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <button onclick="toAdd()">添加儿童</button>
                </li>
            </ul><!-- /.breadcrumb -->
        </div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div>
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach items="${childInfoList}" var="childInfoList">
                                    <tr>
                                        <td><span>${childInfoList.childname}</span></td>
                                        <td>
                                            <div class="">
                                                <button class="green" onclick="toEdit(${childInfoList.id})">
                                                    <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                    编辑儿童
                                                </button>

                                                <button class="red" onclick="del(${childInfoList.id})">
