...
<head>
    ...
    <script>
        ...
        function back() {
            window.location.href = "child/list";
        }
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="child/edit"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="childName" value="${childInfo.childname}" placeholder="儿童名称"
                            ...
                            <input type="hidden" name="oldName" value="${childInfo.childname}">
                        </form>
